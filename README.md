...
![スクリーンショット 2022-11-21 164116](https://user-images.githubusercontent.com/96648305/202992432-321bf472-c405-4d2c-a413-db50beb3b306.png)

1. 混ぜたい画像とマスク画像を用意する。  
2. 画像を設定・取得して、混ぜる  
```
いつもの公開プロパティで設定できるようにする
Properties
    {
...
### 【Unityシェーダ入門】シェーダでワイプエフェクトを作る - おもちゃラボ
### 【Unityシェーダ入門】画面をセピア色にするポストエフェクトを作る - おもちゃラボ
